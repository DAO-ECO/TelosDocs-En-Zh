...
2. Generate a new set of keys. (These are for a Telos account.)
    ...
    <p align="center">Click "Create New Account" to get to the next screen. You do not need a new account.
    </p>
    ...
    <p align="center">Enter a made-up account name. Any 12 digit account name/number will do.</p>
    ...
    <p align="center">Copy/Paste your Keys to a safe place! <br /> Offline storage is recommended.</p>
